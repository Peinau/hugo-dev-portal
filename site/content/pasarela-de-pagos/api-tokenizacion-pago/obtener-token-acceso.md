...
![Ejemplo de client_id y client_secret](/pasarela-de-pagos/api-tokenizacion-pago/images/portal-1.png)
...
Ir al paso [2. Crear una Intención de Captura]({{%relref "crear-intencion-captura.md"%}})
